...
class RegisterUserByCare extends StatefulWidget {
  const RegisterUserByCare({super.key});

  @override
  State<RegisterUserByCare> createState() => _RegisterUserByCareState();
}

class _RegisterUserByCareState extends State<RegisterUserByCare> {
